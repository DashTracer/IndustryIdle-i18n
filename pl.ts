export const PL = {
    ...
    FuelConsumption: "%{fuel} zużycia",
    FuelEconomy: "Ekonomia paliwowa",
    FuelProduction: "%{fuel} produkcji",
    FuelInStorage: "%{fuel} na stanie",
    Plastic: "Plastik",
    FuelSurplus: "%{fuel} nadwyżki",
    Petrol: "Benzyna",
    Buy: "Kup",
    ...
    SortByPrice: "Cena",
    SortByAmount: "Ilość",
    NotEnoughResourcesForTrade: "W Centrum Handlu nie ma wystarczająco produktów, by wykonać tę akcję",
    ...
    TradeCenter: "Rynek",
    Resources: "Surowce",
    NotEnoughPower: "💡 Nie generujesz wystarczającej ilości prądu, spróbuj zwiększyć produkcje energii",
    NotEnoughFuel: "Niewystarczająca ilość %{fuel} do wykonanie tej akcji",
    ...
    PowerSurplus: "Nadwyżka energetyczna",
    Level: "Poziom",
    Power: "Moc/Zasilanie",
